...
const NotificationItem: React.FC<{ notification: NotificationProps }> = ({ notification }) => {
  ...
  return (
    ...
    >
      <div className={cn(
        "h-2 w-2 mt-1.5 rounded-full flex-shrink-0 transition-transform duration-200",
      ...
      <div className="flex items-center justify-between p-4">
        ...
        <div className="flex items-center">
          <Sheet>
            ...
            <SheetContent side="left" className="p-0 w-72 border-r border-gray-200 shadow-xl">
              <Sidebar />
            </SheetContent>
          </Sheet>
          ...
          <Popover>
            <PopoverTrigger asChild>
              ...
              >
                ...
                {unreadCount > 0 && (
                  <Badge className="absolute -top-1 -right-1 px-1.5 py-0.5 bg-rs-red text-white text-xs animate-pulse">
                    {unreadCount}
                  </Badge>
                )}
              </Button>
