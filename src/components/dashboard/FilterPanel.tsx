...
const FilterPanel: React.FC = () => {
  ...
  return (
    <Card 
      className={`w-full transition-all duration-300 hover:shadow-lg bg-white/95 backdrop-blur-sm border border-slate-200/60 ${isHovering ? 'shadow-md translate-y-[-2px]' : 'shadow-sm'} mb-6`} 
      ...
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between">
          ...
          <Collapsible open={filtersOpen} onOpenChange={setFiltersOpen}>
            <CollapsibleTrigger className="h-7 w-7 rounded-full flex items-center justify-center hover:bg-gray-100 transition-colors">
          ...
          <CardContent className="space-y-4 pt-0">
            ...
            <div className="space-y-2">
              ...
              <Popover>
                ...
                <PopoverContent className="w-auto p-0 shadow-lg border border-gray-100 animate-in fade-in-50 zoom-in-95 z-50">
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <SelectContent className="border-gray-200 shadow-md animate-in slide-in-from-top-1 zoom-in-95 z-50">
